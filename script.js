...
//triangle 
let triangleCalculateSubmit = document.getElementById('triangleCalculate');
triangleCalculateSubmit.addEventListener('click',function(){
    let values = getValues('TriangleField1', 'TriangleField2', 'triangleDisplay1', 'triangleDisplay2', 'triangleValueArea', 'triangleInputArea');
    let newValue1 = values.value1;
    let newValue2 = values.value2;
    if(values.valueField1 == '' || values.valueField2 == ''){
        alert("Enter valid number");
    }
    else{
        if(typeof(newValue1) =='number' && typeof(newValue2) == 'number'){
            if(newValue1>=0 && newValue2>=0){
                let result = calculation1(newValue1, newValue2);
                addingResult('Triangle', result)
                console.log('Triangle', typeof(newValue1), newValue1, typeof(newValue1), newValue2, "result: ", result);
            }
            else{
                alert("Number should be positive");
            }
...
//rectangle
let rectangleCalculateSubmit = document.getElementById('rectangleCalculate');
rectangleCalculateSubmit.addEventListener('click', function(){
    ...
    if(values.valueField1 == '' || values.valueField2 == ''){
        ...
        if(typeof(newValue1) =='number' && typeof(newValue2) == 'number'){
            if(newValue1>=0 && newValue2>=0){
                let result = calculation2(newValue1, newValue2);
                addingResult('Rectangle', result)
                console.log('Rectangle', typeof(newValue1), newValue1, typeof(newValue1), newValue2, "result: ", result);
            }
            else{
                alert("Number should be positive");
            }
...
//parallelogram
let parallelogramCalculateSubmit = document.getElementById('parallelogramCalculate');
parallelogramCalculateSubmit.addEventListener('click',function(){
    ...
    if(values.valueField1 == '' || values.valueField2 == ''){
        ...
        if(typeof(newValue1) =='number' && typeof(newValue2) == 'number'){
            if(newValue1>=0 && newValue2>=0){
                let result = calculation2(newValue1, newValue2);
                addingResult('Parallelogram', result);
                console.log('Parallelogram', typeof(newValue1), newValue1, typeof(newValue1), newValue2, "result: ", result);
            }
            else{
                alert("Number should be positive");
            }
...
//Rhombus
let rhombusCalculateSubmit = document.getElementById('rhombusCalculate');
rhombusCalculateSubmit.addEventListener('click',function(){
    ...
    if(values.valueField1 == '' || values.valueField2 == ''){
        ...
        if(typeof(newValue1) =='number' && typeof(newValue2) == 'number'){
            if(newValue1>=0 && newValue2>=0){
                let result = calculation1(newValue1, newValue2);
                addingResult('Rhombus', result);
                console.log('Rhombus', typeof(newValue1), newValue1, typeof(newValue1), newValue2, "result: ", result);
            }
            else{
                alert("Number should be positive");
            }
...
//Pentagon
let pentagonCalculateSubmit = document.getElementById('pentagonCalculate');
pentagonCalculateSubmit.addEventListener('click',function(){
    ...
    if(values.valueField1 == '' || values.valueField2 == ''){
        ...
        if(typeof(newValue1) =='number' && typeof(newValue2) == 'number'){
            if(newValue1>=0 && newValue2>=0){
                let result = calculation1(newValue1, newValue2);
                addingResult('Pentagon', result);
                console.log('Pentagon', typeof(newValue1), newValue1, typeof(newValue1), newValue2, "result: ", result);
            }
            else{
                alert("Number should be positive");
            }
...
ellipseCalculate.addEventListener('click',function(){
    ...
    if(values.valueField1 == '' || values.valueField2 == ''){
        ...
        if(typeof(newValue1) =='number' && typeof(newValue2) == 'number'){
            if(newValue1>=0 && newValue2>=0){
                let result = calculation3(newValue1, newValue2);
                addingResult('Ellipse', result);
                console.log('Ellipse', typeof(newValue1), newValue1, typeof(newValue1), newValue2, "result: ", result);
            }
            else{
                alert("Number should be positive");
            }
